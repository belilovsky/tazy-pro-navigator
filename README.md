...
Production build intentionally ships only the WebP files used by the page plus optimized `overview-og.jpg` for Open Graph. Drafts and unused PNG sources stay in the repository, not in the live release.
